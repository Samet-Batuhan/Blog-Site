    ...
    <div class="container">
      ...
      <div class="form-container">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="konu" placeholder="GİRİŞ YAPINIZ" name="title"
            value="<?php echo isset($_POST['title']) ? $_POST['title'] : ''; ?>" readonly>
        </div>

        <div class="form-group">
          <label for="yazi">Blog Yazınızı Giriniz</label>
          <textarea class="form-control" id="yazi" rows="12" placeholder="GİRİŞ YAPINIZ" name="content"
            readonly><?php echo isset($_POST['content']) ? $_POST['content'] : ''; ?></textarea>
      ...
      <button type="submit" class="btn btn-outline-dark button-group" disabled name="sendPost">Yükle</button>
      ...
      <div class="button-group " style=" border: 2px solid #ccc; margin-bottom: 50px;">
        ...
        <div class="d-flex justify-content-end">
          <button type="button" class="btn btn-outline-dark ">
            <a href="?silid=<?php echo $content["post_id"]; ?>" onclick="return false;"
              style="pointer-events: none; color: grey;">Sil</a></button>
          <button type="button" class="btn btn-outline-dark">
            <a href="duzenle.php?duzid= <?php echo $content["post_id"]; ?>" onclick="return false;"
              style="pointer-events: none; color: grey;">Düzenle</a></button>
        </div>
      </div>
  ...
  <div style="min-height: auto; display: flex; flex-direction: column;">
    ...
    <footer style="background-color: #333; color: #fff; padding: 20px 0; text-align: center; margin-top: auto;">
      ...
      <div>
        ...
        <a href="https://www.instagram.com/" target="_blank" style="color: #fff;"><i class="fa-brands fa-instagram"></i>
          Instagram</a>
      </div>
    </footer>
    <!-- Footer Section End -->
