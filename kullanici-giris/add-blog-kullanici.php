...
<body>
    ...
    <form method="POST">
        <div class="container">
            <h1 id="baslik-blog">Blog Ekle</h1>
            ...
            if (isset($_POST["sendPost"])) {
                ...
                if ($title != "" && $content != "") {
                    ...
                    header("Refresh: 1; url=add-blog-kullanici.php");
                } else {
    ...
    <div class="container">
        ...
        while ($content = $veri->fetch_array()) {
            ...
            ?>
            <br>
            <div class="button-group " style=" border: 2px solid #ccc; padding-bottom: 15px; margin-bottom: 50px;">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-outline-dark">
                        <a href="duzenle-kullanici.php?duzid= <?php echo $content["post_id"]; ?>">Düzenle</a></button>
                </div>
            </div>
