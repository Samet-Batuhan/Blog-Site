...
<body>
    ...
    <section id="menu">
        ...
        <nav>
            ...
            <label for="">Kullanici Girişi Başarılı</label>
        </nav>
    </section>
    <form method="POST">
        <div class="container">
            <h1 id="baslik-blog"><i class="fa-solid fa-blog"></i> Blog Sayfam</h1>

            <div class="form-container">
                <div class="form-group">
                    <label for="konu">Konu</label>
                    <input type="text" class="form-control" id="konu" placeholder="Konu" name="title" value="<?php
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="yazi" rows="12" placeholder="Blog Yazınızı Giriniz..."
                        name="content"><?php
                        echo $veri["post_content"]; ?></textarea>
                </div>
            ...
            if (isset($_POST["sendPost"])) {
                ...
                if ($title != "" && $content != "") {
                    ...
                    header("Refresh: 1; url=duzenle-kullanici.php?duzid=$id");
                } else {
