...
<body>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('../img/iletisim.jpg'); height:500px;  background-size: cover; background-repeat: no-repeat; background-position: center;">
